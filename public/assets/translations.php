...
$error_translations = [
    'en' => [
        ...
        'createShop' => 'If the shop name is written, its name must be at least two characters.',
        'createQty' => 'Quantity is required.',
        'createUnit' => 'Unit is required.',
        'createSpot' => 'Spot is required.',
        'createPeremption' => 'The peremption date is required and can not be before today\'s date.',
    ...
    'fr' => [
        ...
        'createShop' => 'Si le nom du magasin est entré, il doit contenir au moins 2 caractères.',
        ...
        'createPeremption' => 'La date de peremption est obligatoire et ne peut pas être plus tôt que la date d\'aujourd\'hui.',
